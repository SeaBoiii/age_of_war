...
export function PauseMenu({ state }: PauseMenuProps) {
  return (
    ...
    >
      <div
        className="ui-glass-panel ui-pop relative w-full max-w-sm overflow-hidden rounded-xl p-4 sm:p-5"
        onClick={(event) => {
          event.stopPropagation();
        }}
      >
        <div className="pointer-events-none absolute -top-12 right-0 h-28 w-28 rounded-full bg-cyan-300/10 blur-3xl" />
        ...
        <div className="mt-4 flex flex-col gap-3">
          <button
            type="button"
            className="ui-pressable ui-shadow-cool inline-flex items-center justify-center gap-2 rounded-md border border-emerald-300/40 bg-emerald-400/20 px-3 py-2 text-sm font-semibold text-emerald-100 hover:bg-emerald-300/30"
            onClick={resumeMatch}
          >
          ...
          <div className="ui-soft-panel rounded-md px-3 py-2.5">
          ...
          <button
            type="button"
            className="ui-pressable mt-9 inline-flex items-center justify-center gap-2 rounded-md border border-rose-300/40 bg-rose-500/20 px-3 py-2 text-sm font-semibold text-rose-100 hover:bg-rose-400/30"
